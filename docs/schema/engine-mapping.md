...
| `project.importance_class` | N/A | `ProjectPara.GetPara_Int(...)` |
...
- **V1 → V2 migration**: All V1 payloads are valid V2 payloads after `migrate_v1_to_v2()` — new fields default to `None`/empty
